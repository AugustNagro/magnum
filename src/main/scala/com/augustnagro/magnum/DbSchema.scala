...
object DbSchema:
  ...
  private def buildDbSchema[
    ...
    '{
      ($dbType: @unchecked) match
        case DbType.SqlCompliant | DbType.Postgres =>
          ${
  ...
  private def oracleDbSchema[EC: Type, E: Type, ID: Type, RES: Type](
      tableNameSql: Expr[String],
      fieldNames: Expr[List[String]],
      ecFieldNames: Expr[List[String]],
      sqlNameMapper: Expr[SqlNameMapper]
    ...
    '{
      ...
      OracleDbSchema(defaultAlias, schemaNames).asInstanceOf[RES]
    }
